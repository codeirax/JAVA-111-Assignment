...
int count = 1;
 ...
 while (true){
  System.out.println("Enter the details of Student "+(count++));
	...
	Student student = new Student(roll,name,marks); // Calling constructor.
	
	students.add(student);  // Adding to array List
	...
	for(Student student: students){  // Iterating over array list
